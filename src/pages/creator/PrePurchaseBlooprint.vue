    ...
    <div class="bg-white">
      ...
      <div v-else>
        <BlooprintTopSection
          ...
          @clicked="
            () => {
              totalReviewCount > 0 ? (showReviewsPopup = true) : null
            }
          "
        />
      </div>
...
<script>
import BlooprintLevelAndDuration from 'src/components/BlooprintLevelAndDuration.vue'
import BlooprintLevelAndDurationSkeleton from 'src/components/BlooprintLevelAndDurationSkeleton.vue'
import PayPerBlooprint from 'src/components/PayPerBlooprint.vue'
import PayPerBlooprintSkeleton from 'src/components/PayPerBlooprintSkeleton.vue'
import BlooprintReviews from 'src/components/BlooprintReviews.vue'
import BlooprintReviewsSkeleton from 'src/components/BlooprintReviewsSkeleton.vue'
import BlooprintCreator from 'src/components/BlooprintCreator.vue'
import BlooprintCreatorSkeleton from 'src/components/BlooprintCreatorSkeleton.vue'
import Milestones from 'src/components/Milestones.vue'
import MilestonesSkeleton from 'src/components/MilestonesSkeleton.vue'
import HangingCard from 'src/components/HangingCard.vue'
import HangingCardSkeleton from 'src/components/HangingCardSkeleton.vue'
import BlooprintIntro from 'src/components/BlooprintIntro.vue'
import BlooprintIntroSkeleton from 'src/components/BlooprintIntroSkeleton.vue'
import BlooprintTopSection from 'src/components/BlooprintTopSection.vue'
import BlooprintTopSectionSkeleton from 'src/components/BlooprintTopSectionSkeleton.vue'
...
export default {
  ...
  methods: {
    ...
    async getAllMilestonesByBlooprintId() {
      this.loading = true
      let list = await this.fetchAllMilestonesByBlooprintId(this.blooprintId)
      this.loading = false
    ...
    async fetchBlooprintRating() {
      let ratingResponse = await this.getBlooprintRating(this.blooprintId)
    ...
    getMilestoneDuration() {
      ...
      this.milestonesList.map(milestone => {
        milestone.attributes.tasks.map(task => {
          console.log('task', task['duration']['days']);
