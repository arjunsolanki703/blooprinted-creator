  ...
  <div>
    ...
    >
      ...
      <q-input
        ...
        ref="fname"
        class="border-input-field input-style text-body1 text-black q-mt-xs q-mb-md-lg q-mb-sm-md q-mb-xs-md q-pb-none"
        maxlength="50"
        readonly
      ...
      <q-input
        ...
        maxlength="50"
        ref="lname"
        class="border-input-field input-style f-w-500 text-body1 text-black q-mt-xs q-mb-md-lg q-mb-sm-md q-mb-xs-md q-pb-none"
        readonly
        onfocus="this.removeAttribute('readonly');"
        lazy-rules
        :rules="[
      ...
      <div
        class="text-regalBlue text-center f-w-400 text-body1 signup-account-margin"
      >
...
export default {
  ...
  props: ['selectedPlan', 'requestFrom'],
  methods: {
