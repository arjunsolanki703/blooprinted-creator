  ...
  <q-card bordered class="card-style" style="border-radius: 20px">
    <q-card-section>
        ...
        <div class="row no-wrap">
          ...
          <div
            class="row items-center text-capitalize text-comet text-fs-14-lh-20 f-w-500 word-break-break-word ellipsis
                cursor-not-allowed author-name"
          >
      ...
      <div class="row items-center" v-else>
        ...
        <div
          class="text-primary cursor-not-allowed q-ml-md reviews-link"
        >
      ...
      <div class="row">
        <div
          class="row share-icon-margin cursor-not-allowed"
          style=""
        >
          <q-avatar square class="q-mr-sm" size="sm">
            <img src="~assets/share-icon.svg" />
          </q-avatar>
          <div class="icon-text q-pt-xs f-w-600 text-manateeGrey">
            Share
          </div>
        </div>
        <div
          class="row cursor-not-allowed"
          style="height: 24px;"
        >
          <q-avatar square class="q-mr-sm" size="sm">
          ...
          <div
            class="icon-text q-pt-xs f-w-600 text-manateeGrey"
