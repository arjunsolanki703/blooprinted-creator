  ...
  <div>
    <div class="full-width full-height main-container">
      ...
      <q-form class="full-width" @submit="accountSubmit" ref="passwordForm">
        ...
        <div class="new-password-field" style="margin-top: 24px">
          ...
          <q-input
            ...
            :rules="[
              ...
              val => val !== currentPassword || 'New password should not match with current password'
            ]"
          >
            <template v-slot:append>
              <q-icon
        ...
        <div style="margin-top: 24px">
          <div class="full-width new-password-field">
