<template>
  <div style="margin-top: 30px; margin-bottom: 60px">
    ...
    >
      ...
      <div class="task-and-day-container col-7">
        <div
          class="justify-end"
          :class="[
            $q.screen.width > 1274 ? 'row items-center' : 'column items-end'
          ]"
        >
          ...
          <div
            ...
            style="height: 8px; width: 8px; border-radius: 8px; margin: 0px 16px;"
          ></div>
          <div class="task-and-day-text text-right">
            {{
