<template>
      ...
      <q-card class="full-width edit-card-popup" style="border-radius:20px">
        ...
        <div class="scroll-area full-width">
          ...
          <label class="edit-card-caption">
            Please update your credit card on file
          </label>
  ...
  <div class="card-information-container" v-else>
    <label class="payment-method full-width">
      <q-skeleton type="text" width="80%"></q-skeleton>
    </label>
    <label class="payment-method-caption full-width">
      <q-skeleton type="text" width="80%"></q-skeleton>
    </label>
    <div class="card-information full-width">
      <div class="card-logo">
        <q-skeleton type="text" width="30px" height="40px"></q-skeleton>
      </div>
      <div class="full-width flex justify-between no-wrap">
        <div class="flex column" style="max-width: 80%; width: 80%">
          <label class="card-number full-width">
            <q-skeleton type="text" width="100%"> </q-skeleton>
          </label>
          <label class="card-expiry full-width">
            <q-skeleton type="text" width="100%"> </q-skeleton>
          </label>
          <label class="email">
