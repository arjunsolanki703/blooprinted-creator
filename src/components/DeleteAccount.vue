<template>
  <div>
    ...
    <div class="full-width full-height main-container">
      <div class="">
        <label class="q-mb-lg delete-heading text-letter-space"
          >Delete Account</label
        >
        <div class="text-regalBlue text-fs-16 f-w-500 text-lh-24">
          This action will permanently delete blooprinted account immediately. This will delete all  your data and information from our database. This action is non reversible.
        </div>
        <div class="text-regalBlue text-fs-16 f-w-500 text-lh-24 q-mt-md">
            Are you ABSOLUTELY SURE you wish to delete this account?
        </div>
        <q-btn
          no-caps
          flat
...
"
            >
              ...
              <span class="delete-popup-message text f-w-500 text-fs-14-lh-20"
                >Are you sure you want to delete your account? When you delete an account your data is erased from our database. This cannot be undone. 
              </span>
            </span>
          </q-card-section>
