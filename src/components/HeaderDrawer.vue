<template>
  ...
  >
    <q-scroll-area class="fit">
      <q-item class="bg-primary" v-if="isLogin">
        <q-item-section>
      ...
      <q-list v-if="isLogin">
        <q-item
          ...
          :to="item.routeTo"
        >
          <q-item-section @click="onTabSelect(item)" class="q-py-sm">
            {{ item.label }}
          </q-item-section>
        </q-item>
        <q-item
          ...
          :to="item.routeTo"
        >
          <q-item-section @click="onMenuItemClick(item)" class="q-py-sm">
            {{ item.label }}
          </q-item-section>
        </q-item>
...
export default {
  data() {
    return {
      ...
      authMenuList: [
        { label: 'Signin', value: 'signin', routeTo: { name: 'login' } },
        { label: 'Signup', value: 'signup', routeTo: { name: 'signup self' } }
      ]
    }
  },
  props: [
