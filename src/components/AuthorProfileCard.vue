    ...
    <q-card bordered class="creator-card">
      <q-card-section>
        <div class="row">
          <q-avatar
            size="7.5rem"
            class="cursor-not-allowed gt-sm"
          >
            <img
              contain
              v-if="
          ...
          <q-avatar
            size="6.25rem"
            class="cursor-not-allowed lt-md"
          >
            <img
              contain
              v-if="
          ...
          <div class="col" style="margin-left: 20px">
            <div
              class="f-w-600 author-name text-regalBlue word-break-break-word ellipsis cursor-not-allowed"
            >
        ...
        <div
          ...
          class="text-primary cursor-not-allowed read-more-text"
        >
          Read more
        </div>
        <div class="row q-mt-lg">
          <div
            class="col-md col-sm-12 col-xs-12 q-mr-md-sm q-mb-sm-md q-mb-xs-md"
            style=""
          >
            <q-btn
              color="primary"
...
export default {
  ...
  props: ['authorDetails'],
  methods: {
    ...mapActions(['unFollowAuthor', 'followAuthor']),
